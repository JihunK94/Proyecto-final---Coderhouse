...
from recetas.views import Ver_comidasList, Ver_comidasAgregar, Ver_comidaDetalle, Ver_comidaModificar, Ver_comidasBorrar, lista_sugerencias, about_me
...
urlpatterns =[
    ...
    path("comidas/sugerencias", lista_sugerencias, name= "lista_sugerencias"),
